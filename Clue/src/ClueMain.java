...
import clue.GamePieces.NotebookPanel;
import clue.GamePieces.Player;
import clue.GamePieces.ShowCardsRoutine;
import clue.Helpers.ClueMap;
import clue.Helpers.Location;
import clue.Helpers.PathFinder;
import clue.Helpers.RoomIconPlacement;
...
public class ClueMain {
    ...
    public static Die dice = new Die();
    ...
    public static void startSinglePlayerGame() {
        ...
        Location scarlet_location = map.getLocationAndSetColor(7, 24, Color.RED);
        Location mustard_location = map.getLocationAndSetColor(0, 17, Color.YELLOW);
        Location green_location = map.getLocationAndSetColor(13, 0, Color.GREEN);
        Location plum_location = map.getLocationAndSetColor(23, 18, Color.MAGENTA);
        Location white_location = map.getLocationAndSetColor(9, 0, Color.WHITE);
        Location peacock_location = map.getLocationAndSetColor(23, 5, Color.BLUE);
        ...
        for (Player player : players) {
			...
			if (player.getSuspectNumber() == SUSPECT_SCARLET) {
				player.setLocation(scarlet_location);
			} else if (player.getSuspectNumber() == SUSPECT_MUSTARD) {
				player.setLocation(mustard_location);
			} else if (player.getSuspectNumber() == SUSPECT_GREEN) {
				player.setLocation(green_location);
			} else if (player.getSuspectNumber() == SUSPECT_PLUM) {
				player.setLocation(plum_location);
			} else if (player.getSuspectNumber() == SUSPECT_WHITE) {
				player.setLocation(white_location);
			} else if (player.getSuspectNumber() == SUSPECT_PEACOCK) {
    ...
    public static void getImageIcon(String file) {
    }
